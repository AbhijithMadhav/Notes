...
public class MailClient extends Frame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7521601904298207106L;
	...
	private TextField fromField = new TextField("browseanddownload@gmail.com", 40);
	private Label toLabel = new Label("To:"); 
	private TextField toField = new TextField("abhijithmadhav@gmail.com", 40);
		...
		public void actionPerformed(ActionEvent event) {
	       ...
	       the message. */
			...
			try {
				...
				System.out.println("Unknown host Exception while creating envelope");
				return;
			}
			try {
